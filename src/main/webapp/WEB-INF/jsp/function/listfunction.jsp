...
<body>
		...
		<c:forEach items="${moduleFunctionList}" var="x">
			...
			<tr>
				<td bgcolor="#FFFFFF" style="word-break: break-all;"><div
						align="center">${x.code}</div></td>
				<td bgcolor="#FFFFFF" style="word-break: break-all;">${x.description}</td>
				<td bgcolor="#FFFFFF"><div align="center">
						<a
							href="javascript:void _delete('function/deletemodulefunction.do?id=${x.fId}','')">删除</a>
					</div></td>
				<td bgcolor="#FFFFFF"><div align="center">
						<a href="modifymodulefunction.jspa?id=${x.fId}">修改</a>
					</div></td>
			</tr>
		</c:forEach>
	</table>
	...
	<form action="<%=contextPath %>/function/addmodulefunction.do" name="form1" method="post"
